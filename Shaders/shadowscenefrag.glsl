...
void  main(void)    {
	...
	float  invDistRatio = lightRadius / distance ;
	float  attenuation = lightColour.w * invDistRatio * invDistRatio;//1.0f - clamp(distance / lightRadius , 0.0,  1.0);
